    ...
    theme: {
        ...
        extend: {
            ...
            colors: {
                ...
                sidebar: {
                    DEFAULT: 'oklch(var(--sidebar, var(--background)))',
                    foreground: 'oklch(var(--sidebar-foreground, var(--foreground)))',
            ...
            boxShadow: {
                ...
                warm: '0 4px 24px 0 oklch(0.50 0.160 38 / 0.12)',
                'warm-lg': '0 8px 40px 0 oklch(0.50 0.160 38 / 0.18)',
            },
            keyframes: {
                'accordion-down': {
                    from: { height: '0' },
